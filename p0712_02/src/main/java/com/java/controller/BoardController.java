...
//	BoardService boardService = new BoardServiceImpl();  //다형성
	...
	public ModelAndView list(@RequestParam(defaultValue = "1") int page, String category, String searchWord) {
...
//			System.out.println("uuid : "+uuid);
	...
	public ModelAndView update(BoardDto bdto, int page) { 
	...
	public String doUpdate(BoardDto bdto,@RequestPart MultipartFile files, int page) {
