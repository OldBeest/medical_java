...
public class FController {
	...
	public String public_data(@RequestParam(defaultValue = "1") String page) throws Exception {
		...
		String service_key = "O1%2Fqdn%2FPNTs%2Bv2YJPW2b3uOPybJX7TleUK2lnSqKUYC7YuvB4wRk%2F9JJzk6iw1vyyA0SjCZaJb8H4m2oDrmXWw%3D%3D";
	...
	@ResponseBody
	public String public_data2(@RequestParam(defaultValue = "부산")String keyword) throws Exception {
